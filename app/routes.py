...
import json
import secrets
from app.forms import ResetPasswordForm, ForgotPasswordForm,UpdateProfileForm  # Create this form class
    ...
    if request.method == 'POST':
        ...
        if form.validate_on_submit():
            ...
            user = User(first_name=form.first_name.data, last_name=form.last_name.data, email=form.email.data,
                        ...
                        state=form.state.data, country=form.country.data,  interests=form.interests.data, 
    ...
    if request.method == 'POST':
        ...
        if form.validate_on_submit():
            ...
            if not post:
                ...
                post.interests = interests  # Assuming you've added interests column to Post model
                post.skills = skills  
                db.session.add(post)
                db.session.commit()
